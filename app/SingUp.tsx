...
const SingUp = () => {
  ...
  return (
   ...
   <View style={tw`flex-1 bg-white px-8 pt-2`,styles.Set}>
        <View style={tw`form space-y-2 mt-3`}>
                <Text style={tw`text-gray-700 ml-4`}>Full Name</Text>
                <TextInput  style={tw`p-4 bg-gray-100 text-gray-700 rounded-2xl mb-3`} value={name} onChange={(e)=>{setname(e.target.value)}} placeholder='Enter Name'/>
                ...
                <TouchableOpacity style={tw`py-3 bg-yellow-400 rounded-xl mt-5`}>
